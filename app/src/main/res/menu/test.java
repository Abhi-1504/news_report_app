package edu.ntust.transferability.sha3;

/**
 * Created by a2735000 on 2015/11/16.
 */
 ...
 * Created by a2735000 on 2015/11/16.
 */
import edu.ntust.transferability.sha3.Keccak;
import java.util.Formatter;
...
public class SHA3 {
    ...
    public String getHash384(String str){
        byte[] b = getByteArray(str);
        String s = getHexStringByByteArray(b);
        Keccak keccak = new Keccak(1600);
        return keccak.getHash(s, 832, 48);
    }

    public String getHash512(String str){
        byte[] b = getByteArray(str);
        String s = getHexStringByByteArray(b);
        Keccak keccak = new Keccak(1600);
        return keccak.getHash(s, 576, 64);
    }
